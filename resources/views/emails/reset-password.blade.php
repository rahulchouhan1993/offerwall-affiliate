    ...
    <tr>
        <td style="padding: 25px 25px 25px 25px;">
            <table cellspacing="0" cellpedding="0" width="100%">
                ...
                <tr>
                    <td style="padding: 0 0 20px 0;">
                        <p style="margin: 1px; font-size: 14px; color: #ffffff;">We have successfully reset your password. You can now log in to your account using the password below.</p>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td style="padding:20px 20px 20px 20px; background-color: #000;" bgcolor="#2E4D91">
            <table cellspacing="0" cellpedding="0" width="100%">
                ...
                <tr>
                    <td style="padding: 0 0 20px 0; max-width: 150px;">
                        <p style="margin: 1px; font-size: 14px; color: #e888de;">New Password:</p>
                    </td>
