...
<div class="bg-[#f2f2f2] p-[15px] md:p-[35px]">
        <div class="flex items-start flex-wrap lg:flex-nowrap gap-[20px] justify-between">
            ...
            <div class="w-[100%] lg:w-[60%] bg-[#fff] p-[15px] md:p-[20px] lg:p-[40px] rounded-[8px] md:rounded-[10px]">
                ...
                <h3 class="flex justify-start gap-[10px] text-[12px] text-[#808080] mb-[30px]"><span>Difficulty: Easy Time</span> <span>Required: 15-30min</span></h3>
                <p class="text-[14px] text-[#808080]">Replace [USER_ID] with the ID of the user in your App. Optionally provide &gender= and &age= to improve demographic targeting. See the full list of optional offerwall parameters, here.</p>
