            ...
            <div class="flex gap-[20px] w-[100%">
                <div class="flex flex-col gap-[5px] w-[100%]">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" class="show-pass absolute top-[16px] right-[15px]"><svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    ...
    $(document).on('mouseup mouseleave', '.show-pass', function () {
