            ...
            <div
                ...
                <div class="flex flex-row items-center justify-between w-full gap-[5px] mb-[15px]">
                    ...
                    <a href="{{ route('add.method') }}" 
                        class="bg-[#D272D2] px-[20px] py-[5px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center cursor-pointer">Add</a>
                    @endif
                </div>
                <div class="w-[100%] overflow-x-auto tableScroll">
                    <table
                        ...
                        <tr>
                            <th
                                class="bg-[#F6F6F6] rounded-tl-[10px] text-[14px] font-[500] text-[#000] px-[10px] py-[13px] text-left  whitespace-nowrap ">
                                Payment Method </th>
                            <th
                                class="bg-[#F6F6F6] text-[14px] font-[500] text-[#000] px-[10px] py-[13px] text-left  whitespace-nowrap">
                                Account Name</th>
                            <th
                                class="bg-[#F6F6F6] text-[14px] font-[500] text-[#000] px-[10px] py-[13px] text-left  whitespace-nowrap">
                                Account Number</th>
                            ...
                            {{-- <th class="bg-[#F6F6F6] text-[14px] font-[500] text-[#000] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            Status</th> --}}
                            <th
                                class="bg-[#F6F6F6] rounded-tr-[10px] text-[14px] font-[500] text-[#000] px-[10px] py-[13px] text-left  whitespace-nowrap">
                                Action</th>
                        </tr>
                                    ...
                                    <td
                                        ...
                                        <a href="{{ route('add.method',['id'=>$paymentMethod->id]) }}" class="edit-method"><svg width="19"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#D272D2" stroke-width="2" stroke-linecap="round"
