    ...
    <div class="flex items-center justify-between gap-[20px] mt-[20px]">
        <div class="flex flex-col justify-between items-start gap-[5px] w-[100%] bg-[#fff] rounded-[5px] md:rounded-[10px] p-[15px]">
            <div class="flex flex-row items-center justify-between w-full gap-[5px] mb-[15px]">
                ...
                <button type="button" onclick="openModal()" class="bg-[#D272D2] px-[20px] py-[5px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center cursor-pointer">Add</button>
            </div>
            <div class="w-[100%] overflow-x-auto tableScroll">
                <table class="w-[100%] border-collapse border-spacing-0 rounded-[10px] border-separate border border-[#E6E6E6]">
                    <tr>
                        <th class="bg-[#F6F6F6] rounded-tl-[10px] text-[14px] font-[500] text-[#1A1A1A] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            Payment Method</th>
                        <th class="bg-[#F6F6F6] text-[14px] font-[500] text-[#1A1A1A] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            Account Name</th>
                        <th class="bg-[#F6F6F6] text-[14px] font-[500] text-[#1A1A1A] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            IBAN</th>
                        <th class="bg-[#F6F6F6] text-[14px] font-[500] text-[#1A1A1A] px-[10px] py-[13px] text-left  whitespace-nowrap">ABA Routing Number</th>
                        <th class="bg-[#F6F6F6] text-[14px] font-[500] text-[#1A1A1A] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            SWIFT / BIC</th>
                        <th class="bg-[#F6F6F6] text-[14px] font-[500] text-[#1A1A1A] px-[10px] py-[13px] text-left  whitespace-nowrap">
                            Status</th>
                    ...
                    <tr>
                        ...
                        <td class="text-[14px] font-[500] text-[#808080] px-[10px] py-[10px] text-left  whitespace-nowrap ">
                            <label class="relative cursor-pointer">
                                ...
                                <div class="w-10 h-5 rounded-full bg-gray-300 peer-checked:bg-[#ce68ce] transition-colors duration-300"></div>
...
<div id="myModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
    <form method="POST" action="{{ route('payment.methods') }}">
        ...
        <div class="flex justify-end space-x-2 mt-4">
            <button type="button" onclick="closeModal()" class="px-4 py-2 bg-[#F5EAF5] w-[100px] border border-[#FED5C3] rounded-[4px] text-[14px] font-[500] text-[#D272D2] text-center">Cancel</button>
