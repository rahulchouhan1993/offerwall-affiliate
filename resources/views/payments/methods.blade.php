            ...
            <div
                ...
                <div class="flex flex-row items-center justify-between w-full gap-[5px] mb-[15px]">
                    ...
                    <button type="button" onclick="openModal()"
                        class="bg-[#D272D2] px-[20px] py-[5px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center cursor-pointer">Add</button>
                </div>
    ...
    <div id="myModal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50 p-4 max-h-[100vh] overflow-y-auto">
        <div class="bg-white w-full max-w-lg mx-auto p-6 rounded-lg shadow-lg relative">
            <div class="modal_body">
                <form class="w-full" method="POST" action="{{ route('payment.methods') }}">
                    @csrf
